...
(* CORE_GENERATION_INFO = "DisplayColor_Leds,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=DisplayColor_Leds,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=19,numReposBlks=19,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=18,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "DisplayColor_Leds.hwdef" *) 
module DisplayColor_Leds
  ...
  wire [6:0]Deco7SEG_0_Out7seg;
  wire [6:0]Deco7SEG_1_Out7seg;
  ...
  assign Out7seg_0[6:0] = Deco7SEG_0_Out7seg;
  assign Out7seg_1[6:0] = Deco7SEG_1_Out7seg;
  ...
  DisplayColor_Leds_Conversor_0_0 Conversor_0
       (.Mode(ModeIncDec_0_out1),
        ...
        .rst(rst_0_1));
  DisplayColor_Leds_Deco7SEG_0_0 Deco7SEG_0
       (.Out7seg(Deco7SEG_0_Out7seg),
        .in1(bin_a_bcd_0_bcd_dec));
  DisplayColor_Leds_Deco7SEG_0_1 Deco7SEG_1
       (.Out7seg(Deco7SEG_1_Out7seg),
  ...
  DisplayColor_Leds_Memoria_0_0 Memoria_0
       (.addr_in(MaquinaEdos_0_address),
        .clk(clk_0_1),
        .cs(xlconstant_0_dout),
        .data_in(Conversor_0_datDec),
        .data_out(Memoria_0_data_out),
  ...
  DisplayColor_Leds_bin_a_bcd_0_0 bin_a_bcd_0
       (.bcd_dec(bin_a_bcd_0_bcd_dec),
        ...
        .rst(rst_0_1),
        .set(Set_0_1));
  DisplayColor_Leds_xlconstant_0_0 xlconstant_0
